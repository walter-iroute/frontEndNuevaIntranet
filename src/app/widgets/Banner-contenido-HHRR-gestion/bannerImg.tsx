...
import { BannerImgEntitycontenidov2HHRR } from './bannerImg.entity';
...
export function BannerImgcontenidov2HHRR(props: WidgetContext<BannerImgEntitycontenidov2HHRR>) {
    ...
    return (
        <div {...dataAttributes} className='banner-containercontenidov2-hhrr row'>
            <div className='block-textcontenidov2-hhrr'>
            ...
            <div className='block-imagecontenidov2-hhrr'>
                {imagen && <img style={{ height: '313px', width: '353px', objectFit:'contain' }} src={imagen.Url} alt={imagen.Title} />}
            </div>
        </div>
    );
}
